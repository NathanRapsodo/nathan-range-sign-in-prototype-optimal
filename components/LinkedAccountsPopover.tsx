          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                {/* End session button */}
                {(linkedAccounts.length > 0 || guests.length > 0) && (
                  <button
                    onClick={() => {
                      setIsSignOutAllOpen(true);
                      onClose(); // Close the accounts popover when opening sign out all modal
                    }}
                    className="px-3 py-1.5 text-xs font-medium text-gray-700 hover:text-red-600 hover:bg-red-50 rounded transition-colors"
                  >
                    End session
                  </button>
                )}
            ...
            <div className="overflow-y-auto flex-1 p-4">
              ...
              <div className="mb-6">
                ...
                {linkedAccounts.length === 0 ? (
                  <p className="text-gray-500 text-sm">No users linked</p>
                ) : (
